...
export default function Testimonials() {
  ...
  return (
    <Section id="testimonials" className="py-20 sm:py-28 relative">
      ...
      {/* ✅ Carousel container */}
      <div className="relative mt-14 overflow-hidden px-4 w-full max-w-full">
        {/* Gradient masks */}
        ...
        <motion.div
          ref={carouselRef}
          className="flex gap-6 cursor-grab w-full max-w-full"
          style={{ x }}
          drag="x"
...
function TestimonialCard({
  ...
  return (
    <motion.div
      ...
      style={{ flex: `0 0 calc((100% - ${(slidesToShow - 1) * gap}px)/${slidesToShow})`, maxWidth: "100%" }}
      className="bg-white dark:bg-zinc-900 rounded-3xl px-6 py-8 sm:px-8 sm:py-10 text-center"
    >
      {/* Avatar */}
      ...
      {/* Quote */}
      <p className="text-zinc-700 dark:text-zinc-200 text-center italic text-sm sm:text-base">
        “{testimonial.quote}”
      </p>
